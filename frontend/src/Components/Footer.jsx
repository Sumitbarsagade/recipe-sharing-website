...
const Footer = () => {
  ...
  <footer class="bg-gradient-to-r bg-black text-white">
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      <div class="lg:flex lg:items-start lg:gap-8">
        <div class=" dark:text-teal-300">
        <p  className="flex items-center space-x-4">
          <img src="/newLogo3.png" alt="" srcset="" className='w-16 '  />
            ...
            <form class="w-full">
              ...
              >
                <input
                  ...
                  class="w-full border-none focus:border-transparent focus:ring-transparent sm:text-sm  text-white"
                />
