...
const SignIn = () => {
  ...
  const ForgotPasswordToggleModal = () => {
     setForgetPasswordModal(true);
  };



  const closeDeleteForgotPasswordToggleModal = () => {
    setForgetPasswordModal(false);  // Hide the modal
  };
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="md:w-11/12 w-full">
                <div class="mb-12">
                  ...
                  <p class="text-sm mt-4 text-gray-800">Don't  have an account <Link to="/signup" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Signup here </Link></p>
                </div>
                ...
                <div class="flex flex-wrap items-center justify-between gap-4 mt-6">
                  ...
                  <div>
                    <a href="jajvascript:void(0);" onClick={ForgotPasswordToggleModal} class="text-blue-600 font-semibold text-sm hover:underline">
                      Forgot Password?
                    </a>
                  </div>
                </div>
    ...
    {forgetPasswordModal && (
            <ForgetPasswordModel closeDeleteForgotPasswordToggleModal={closeDeleteForgotPasswordToggleModal}  />
           )}
